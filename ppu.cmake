...
SET(PPU_CFLAGS "${PPU_CFLAGS} -funroll-loops -fomit-frame-pointer -fstrict-aliasing")
SET(PPU_CFLAGS "${PPU_CFLAGS} -ftree-vectorize -funsafe-math-optimizations")
SET(PPU_CFLAGS "${PPU_CFLAGS} -ffast-math")
